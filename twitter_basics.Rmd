...
## Setup
```{r load data, message=FALSE, warning=FALSE, include=TRUE, results='hide'}
...
```{r api, eval=FALSE, include=TRUE, results='hide'}
...
#### (Or jump to step 3 if you've downloaded the ["trump_tweets.csv"](https://drive.google.com/file/d/16CrtaNqrNjMDGB5m9PIjAHH1MrUgiBej/view?usp=sharing) data directly)
```{r collect tweets, eval=FALSE, include=TRUE, results='hide'}
...
```{r map, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r wordcloud, echo=TRUE, results='hide'}
...
```{r wordcloud2, echo=TRUE, results='hide'}
